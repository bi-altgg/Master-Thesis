...
energyval = np.loadtxt('eigenvalue(1.2).dat',dtype = 'float')
print(energyval)
...
np.savetxt('(1.2)free_energ.txt', free_energy)
for sgstrn in arrayofsitegamstrn:
    ...
    print(plot)
    np.savetxt('(1.2)datafile_for_smal_lattice_size'+ str(sgstrn[2]) + '.txt', plot, )
