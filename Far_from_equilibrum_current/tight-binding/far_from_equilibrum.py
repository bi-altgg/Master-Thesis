...
np.savetxt("/home/bishal/Master's thesis/Codes/Far_from_equilibrum_current/tight-binding/x_axis.txt", mu_R)
...
for i in range(len(mu_R)):
    ...
    plot.append(current_full2(mu_L,mu_R[i]))
    print(i)
np.savetxt("/home/bishal/Master's thesis/Codes/Far_from_equilibrum_current/tight-binding/current_file(0.5)(0.0)" + '.txt', plot )
np.savetxt("/home/bishal/Master's thesis/Codes/Far_from_equilibrum_current/tight-binding/x_axis.txt", mu_R)
...
for i in range(len(mu_R)):
    ...
    plot.append(current_full2(mu_L,mu_R[i]))
    print(i)
np.savetxt("/home/bishal/Master's thesis/Codes/Far_from_equilibrum_current/tight-binding/current_file(0.9)(0.0)" + '.txt', plot )
np.savetxt("/home/bishal/Master's thesis/Codes/Far_from_equilibrum_current/tight-binding/x_axis.txt", mu_R)
...
for i in range(len(mu_R)):
    ...
    plot.append(current_full2(mu_L,mu_R[i]))
    print(i)
np.savetxt("/home/bishal/Master's thesis/Codes/Far_from_equilibrum_current/tight-binding/current_file(1.5)(0.0)" + '.txt', plot )
np.savetxt("/home/bishal/Master's thesis/Codes/Far_from_equilibrum_current/tight-binding/x_axis.txt", mu_R)
...
for i in range(len(mu_R)):
    ...
    plot.append(current_full2(mu_L,mu_R[i]))
    print(i)
np.savetxt("/home/bishal/Master's thesis/Codes/Far_from_equilibrum_current/tight-binding/current_file(2.0)(0.0)" + '.txt', plot )
np.savetxt("/home/bishal/Master's thesis/Codes/Far_from_equilibrum_current/tight-binding/x_axis.txt", mu_R)
