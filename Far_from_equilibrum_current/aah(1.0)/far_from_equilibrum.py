...
mu_L = 0.0
mu_R = np.linspace(0.01,2000,100)
print(mu_R)
beta_left = 1/100
beta_right = 1/100
beta_probe = 1/100
...
for i in range(len(mu_R)):
    ...
    print(i)
np.savetxt("/home/bishal/Master's thesis/Codes/Far_from_equilibrum_current/aah(1.0)/current_file(0.1)(1.0)" + '.txt', plot )
np.savetxt("/home/bishal/Master's thesis/Codes/Far_from_equilibrum_current/aah(1.0)/x_axis.txt", mu_R)
...
for i in range(len(mu_R)):
    ...
    plot.append(current_full2(mu_L,mu_R[i]))
    print(i)
np.savetxt("/home/bishal/Master's thesis/Codes/Far_from_equilibrum_current/aah(1.0)/current_file(0.5)(1.0)" + '.txt', plot )
np.savetxt("/home/bishal/Master's thesis/Codes/Far_from_equilibrum_current/aah(1.0)/x_axis.txt", mu_R)
...
for i in range(len(mu_R)):
    ...
    plot.append(current_full2(mu_L,mu_R[i]))
    print(i)
np.savetxt("/home/bishal/Master's thesis/Codes/Far_from_equilibrum_current/aah(1.0)/current_file(0.9)(1.0)" + '.txt', plot )
np.savetxt("/home/bishal/Master's thesis/Codes/Far_from_equilibrum_current/aah(1.0)/x_axis.txt", mu_R)
...
for i in range(len(mu_R)):
    ...
    plot.append(current_full2(mu_L,mu_R[i]))
    print(i)
np.savetxt("/home/bishal/Master's thesis/Codes/Far_from_equilibrum_current/aah(1.0)/current_file(1.5)(1.0)" + '.txt', plot )
np.savetxt("/home/bishal/Master's thesis/Codes/Far_from_equilibrum_current/aah(1.0)/x_axis.txt", mu_R)
...
for i in range(len(mu_R)):
    ...
    plot.append(current_full2(mu_L,mu_R[i]))
    print(i)
np.savetxt("/home/bishal/Master's thesis/Codes/Far_from_equilibrum_current/aah(1.0)/current_file(2.0)(1.0)" + '.txt', plot )
np.savetxt("/home/bishal/Master's thesis/Codes/Far_from_equilibrum_current/aah(1.0)/x_axis.txt", mu_R)
